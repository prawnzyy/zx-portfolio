...
import RotatingRole from "@/hooks/rotatingRole";
        ...
        <div className="flex flex-col">
            <CustomSection className='container mx-auto flex flex-col sm:flex-row gap-4 sm:p-4 p-3'>
                ...
                <div className="w-full sm:w-1/2 order-2 sm:order-1 m-auto">
                    <div className='max-w-[500px] ms-auto'>
                        <div className='font-bold text-6xl text-start'>Hi</div>
                        <div className='text-2xl text-start mt-3'>I am Seah Zi Xiang</div>
